...
public class ChooseCIty implements ActionListener
{
	...
	void Choose(String cuser)
	{
		...
		l1 = new JLabel(new ImageIcon("/home/mayuresh/Downloads/IMAGES/1.jpg"));
		p11.add(l1);
		...
		l2 = new JLabel(new ImageIcon("/home/mayuresh/Downloads/IMAGES/2.jpg"));
		p22.add(l2);
		l2.setBounds(10, 3 , 200, 298);
		i2 = new JButton("info");
		p22.add(i2);
		i2.setBounds(70, 320, 76, 76);
		i2.setContentAreaFilled(true);
		...
		l3 = new JLabel(new ImageIcon("/home/mayuresh/Downloads/IMAGES/3.jpg"));
		p33.add(l3);
		l3.setBounds(10, 3 , 200, 298);
		i3 = new JButton("info");
		p33.add(i3);
		i3.setBounds(70, 320, 76, 76);
		i3.setContentAreaFilled(true);
		...
		l4 = new JLabel(new ImageIcon("/home/mayuresh/Downloads/IMAGES/4.png"));
		p44.add(l4);
		l4.setBounds(10, 3 , 200, 298);
		i4 = new JButton("info");
		p44.add(i4);
		i4.setBounds(70, 320, 76, 76);
		i4.setContentAreaFilled(true);
		...
		l5 = new JLabel(new ImageIcon("/home/mayuresh/Downloads/IMAGES/5.jpg"));
		p55.add(l5);
		l5.setBounds(10, 3 , 200, 298);
		i5 = new JButton("info");
		p55.add(i5);
		i5.setBounds(70, 320, 76, 76);
		i5.setContentAreaFilled(true);
		...
		l6 = new JLabel(new ImageIcon("/home/mayuresh/Downloads/IMAGES/6.jpg"));
		p66.add(l6);
		l6.setBounds(10, 3 , 200, 298);
		i6 = new JButton("info");
		p66.add(i6);
		i6.setBounds(70, 320, 76, 76);
		i6.setContentAreaFilled(true);
		...
		logout = new JButton(new ImageIcon("/home/mayuresh/Downloads/IMAGES/logout.png"));
		information.add(logout);
		logout.setBounds(1220, 15, 120, 120);
		logout.setContentAreaFilled(false);
		logout.setFocusPainted(false);
		logout.setBorderPainted(false);
		logout.addActionListener(this);
		
		movie_name = new JLabel("War");
		...
		for(int i = 0 ; i < 6 ; i++)
		{
			b[i] = new JButton(new ImageIcon("/home/mayuresh/Downloads/IMAGES/book2.png"));
			f.add(b[i]);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == i1)
		{
			try{
			  Class.forName("com.mysql.jdbc.Driver");
	    	   ...
	    	   String qry = "select * from movie where movie = 'Chhichhore'"  ;
		...
		if(e.getSource() == i2)
		{
			try{
			  Class.forName("com.mysql.jdbc.Driver");
	           java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost/movies","root","password");
	    	   String qry = "select * from movie where movie = 'Joker'"  ;
		...
		if(e.getSource() == i3)
		{
			try{
			  Class.forName("com.mysql.jdbc.Driver");
	           java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost/movies","root","password");
	    	   String qry = "select * from movie where movie = 'Section-375'"  ;
		...
		if(e.getSource() == i4)
		{
			try{
			  Class.forName("com.mysql.jdbc.Driver");
	           java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost/movies","root","password");
	    	   String qry = "select * from movie where movie = 'Dream-Girl'"  ;
		...
		if(e.getSource() == i5)
		{
			try{
			  Class.forName("com.mysql.jdbc.Driver");
	           java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost/movies","root","password");
	    	   String qry = "select * from movie where movie = 'War'"  ;
		...
		if(e.getSource() == i6)
		{
			try{
			  Class.forName("com.mysql.jdbc.Driver");
	           java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost/movies","root","password");
	    	   String qry = "select * from movie where movie = 'Mission-Mangal'"  ;
		...
		{
			f.dispose();
			new AvailabilityList().Availability("Chhichhore",String.valueOf(c.getSelectedItem()),signed_user);
		}
		if(e.getSource() == b[1])
		{
			f.dispose();
			new AvailabilityList().Availability("Joker",String.valueOf(c.getSelectedItem()),signed_user);
		}
		if(e.getSource() == b[2])
		{
			f.dispose();
			new AvailabilityList().Availability("Section-375",String.valueOf(c.getSelectedItem()),signed_user);
		}
		if(e.getSource() == b[3])
		{
			f.dispose();
			new AvailabilityList().Availability("Dream-Girl",String.valueOf(c.getSelectedItem()),signed_user);
		}
		if(e.getSource() == b[4])
		{
			f.dispose();
			new AvailabilityList().Availability("War",String.valueOf(c.getSelectedItem()),signed_user);
		}
		if(e.getSource() == b[5])
		{
			f.dispose();
			new AvailabilityList().Availability("Mission-Mangal",String.valueOf(c.getSelectedItem()),signed_user);
		}
