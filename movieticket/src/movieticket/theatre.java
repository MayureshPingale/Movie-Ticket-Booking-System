...
public class theatre implements ActionListener
{
	...
	JLabel screen , amount , am , veh, logo , scr , paypal , visa , maes , gpay , card , coup , nc , password , bill , pprice, suser,Succesfull ;
	String qry , sh;
	    ...
	    theatre(String show, String cuser)
	{
        ...
        back1 = new JButton("CANCEL");
		f.add(back1);
		back1.setBounds(1260, 10, 100, 100);
       ...
       paypal = new JLabel(new ImageIcon("/home/mayuresh/Downloads/IMAGES/paypal.png"));
       payment_p.add(paypal);
       paypal.setBounds(40, 300, 319, 110);
       ...
       payment.setBounds(250,430,110,40);
       payment.addActionListener(this);
       
       discount.setBounds(60,430, 110, 40);
	...
	public void actionPerformed(ActionEvent e) 
	{
		// TODO Auto-generated method stub
		 ImageIcon im2 = new ImageIcon("/home/mayuresh/Downloads/IMAGES/scooter.png");
		 ImageIcon im3 = new ImageIcon("/home/mayuresh/Downloads/IMAGES/auto.png");
		 ImageIcon im4 = new ImageIcon("/home/mayuresh/Downloads/IMAGES/smallcar.png");
		 ImageIcon im5 = new ImageIcon("/home/mayuresh/Downloads/IMAGES/bigcar.png");
		 ImageIcon im6 = new ImageIcon("/home/mayuresh/Downloads/IMAGES/van.png");
		 ImageIcon im7 = new ImageIcon("/home/mayuresh/Downloads/IMAGES/bus.png");
	    ...
	    if(e.getSource() == payment )
	    {
	    	...
	    	try
	    	{
		    	...
		    	Succesfull = new JLabel(new ImageIcon("/home/mayuresh/Downloads/IMAGES/paysuc.png"));
		    	f.add(Succesfull);
		    	Succesfull.setBounds(650,630,258,324);
	    ...
	    {
	    	if((c.getText().matches("12")) && (bil.getText().matches("12345")))
	    	{
	    		pprice.setText("Amount : "+String.valueOf(NoTicket*200));
	    		price = 200 ;
	    	}
	    	else if((c.getText().matches("abc")) && (bil.getText().matches("23456")))
	    	{
	    		pprice.setText("Amount : "+String.valueOf(NoTicket*price));
	    		price = 200 ;
	    	}
	    	else if((c.getText().matches("abc12")) && (bil.getText().matches("67890")))
	    	{
	    		pprice.setText("Amount : "+String.valueOf(NoTicket*200));
	    		price = 200 ;
	    	}
	    	else if((c.getText().matches("xyz")) && (bil.getText().matches("78901")))
	    	{
	    		pprice.setText("Amount : "+String.valueOf(NoTicket*200));
	    		price = 200 ;
	    	}
	    	else if((c.getText().matches("fg")) && (bil.getText().matches("88002")))
	    	{
	    		pprice.setText("Amount : "+String.valueOf(NoTicket*200));
	    		price = 200 ;
	    	}
